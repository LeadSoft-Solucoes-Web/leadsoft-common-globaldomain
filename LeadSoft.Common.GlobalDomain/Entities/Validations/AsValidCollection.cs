...
{
    /// <summary>
    /// Classe abstrata base que implementa o comportamento de validação para objetos de coleção base. 
    /// Esta classe implementa a CollectionsBase <see cref="CollectionsBase"/> para fornecer básicos de uma entidade de coleção.
    /// Implementa também a interface <see cref="IValidation"/> para fornecer um mecanismo padrão de validação.
    /// </summary>
    public abstract class AsValidCollection : CollectionsBase, IValidation
    {
        /// <summary>
