...
namespace LeadSoft.Common.GlobalDomain.DTOs
{
    ...
    public partial class DTOEmailContact
    {
        ...
        public static implicit operator DTOEmailContact(EmailContact aEmailContact)
        {
        ...
        public static implicit operator EmailContact(DTOEmailContact aDtoEmailContact)
        {
